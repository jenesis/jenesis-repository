...
Already on WireMock: free 6 modules, downstream 38 modules.

**Deliberate residuals (keep — WireMock cannot model these at the wire level):**

- `downstream …/gateway/test/FaultUpstream.java` — a real loopback socket that
...
- `downstream …/ai/test/RecordedModelServer.java`, `emulator/test/EmulatorTest`,
  ...
  migrate to WireMock.
- `downstream …/cli/test/CliDispatcherTest` — **REVIEW**.
