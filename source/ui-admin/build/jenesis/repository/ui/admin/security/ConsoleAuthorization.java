...
final class ConsoleAuthorization {
    ...
    static void rules(AuthorizeHttpRequestsConfigurer<HttpSecurity>.AuthorizationManagerRequestMatcherRegistry auth,
        ...
        auth
                ...
                .requestMatchers("/instances/create", "/instances/delete", "/instances/reclaim").hasRole("SUPERADMIN")
                ...
                .requestMatchers("/instances", "/instances/select")
                        .access(ConsoleAccessRule.holdsSomething(access))
                .requestMatchers("/setup", "/setup/**").hasRole("SUPERADMIN")
                .requestMatchers("/settings", "/settings/**").hasRole("SUPERADMIN")
                ...
                .requestMatchers("/walks", "/walks/**").hasRole("SUPERADMIN")
                ...
                .requestMatchers("/observability", "/catalog", "/posture").hasRole("SUPERADMIN")
                .requestMatchers("/admin/**").access(tenants.require(UserDirectory.Role.ADMIN))
                ...
                .requestMatchers("/credentials/**").access(tenants.require(UserDirectory.Role.ADMIN))
                ...
                .requestMatchers("/deploy").access(tenants.require(UserDirectory.Role.ADMIN))
                .requestMatchers(HttpMethod.POST, "/repositories/quota", "/repositories/rate-limit")
                ...
                .requestMatchers(HttpMethod.POST, "/projects/*/evict/**")
                        .access(tenants.require(UserDirectory.Role.ADMIN))
                ...
                .requestMatchers(HttpMethod.GET, "/repositories", "/repositories/**", "/projects", "/projects/**")
