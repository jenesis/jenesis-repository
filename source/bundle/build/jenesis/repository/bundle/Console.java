 ...
 * {@code application.properties}. The console reads the same store the server writes ({@code JENREG_STORE} /
 * {@code jenreg.filesystem.root}), so both nodes off one image see one deployment.
 */
