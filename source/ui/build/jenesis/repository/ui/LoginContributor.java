...
/**
 * The seam a login mechanism plugs into: {@link ConsoleSecurityConfig} owns the authorization rules, the entry point and
 * logout, and applies every {@code LoginContributor} bean to the shared {@link HttpSecurity}, so a mechanism (the
 * bundled OAuth2/OIDC via {@link OAuth2ClientConfig}, or another added later) contributes its own
