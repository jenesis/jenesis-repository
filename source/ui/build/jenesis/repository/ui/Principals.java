 ...
 * named). A downstream console replaces this with its own tenant-and-role membership model by contributing its own
 * bean; the seam is the same. This deliberately does not carry the downstream multi-tenant machinery.
 */
