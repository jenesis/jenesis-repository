 ...
 * deciding whether to retry has something better than the message text to key on. Depends only on the format SPI (for
 * the shared {@code ProxyFormat.Fetcher}) and java.base; a connector reads and writes its own JSON with Jackson.
 *
 * @jenesis.release 25
