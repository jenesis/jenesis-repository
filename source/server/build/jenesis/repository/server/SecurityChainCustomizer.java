 ...
 * webhook, an OIDC token-exchange endpoint) or add a filter (a request-body cap) over the chain, without
 * excluding this auto-configuration and forking the whole chain - the composition seam that keeps the chain
