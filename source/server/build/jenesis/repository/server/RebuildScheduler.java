 ...
 * without waiting for the artifact to be republished. It runs on its own single daemon scheduler because it is a free-core bean that owns its start/close lifecycle - one of the two periodic drivers core/AGENTS.md names as keeping a private timer rather than the composition root's scheduler. The cadence is {@code jenreg.rebuild.interval} (a week by
