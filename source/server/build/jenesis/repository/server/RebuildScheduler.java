...
/**
 * This composition's scheduled driver of the shared {@link RebuildPass}: on a cadence it joins the pass over the
 ...
 * without waiting for the artifact to be republished. It runs on its own single daemon scheduler because it is a bean that owns its start/close lifecycle - one of the two periodic drivers core/AGENTS.md names as keeping a private timer rather than the composition root's scheduler. The cadence is {@code jenreg.rebuild.interval} (a week by
