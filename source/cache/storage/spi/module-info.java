 ...
 * free core's java.base-light store contract, so an app or backend builds on it without pulling in a server. A
 ...
 *
 * <p>The dependencies are both the free core's, and both for the same reason (&sect;2 - shared mechanism lives in the
 * free core and is reused, never copied). {@code build.jenesis.repository.store} carries the shared
