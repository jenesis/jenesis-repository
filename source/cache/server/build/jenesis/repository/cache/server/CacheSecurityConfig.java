 ...
 * the bundle - would have had {@code /cache/**} governed by whatever chain happened to match, which for a
 ...
 *
 * <p>The chain scopes {@code /cache/**} to permit-all with CSRF disabled, because {@link CacheController} does its
 ...
 *
 * <p>It governs {@code /cache/**} and nothing else, deliberately. The management surface of a cache running ALONE
