/**
 * Negative controls for the reusable contract census: static declarations, runtime discovery and fixture coverage
 * each fail independently, duplicate provider names/classes fail, stale registrations fail, and multiline
 * {@code provides} lists are parsed.
 *
 * @jenesis.release 25
 * @jenesis.test build.jenesis.repository.contract.testkit
 ...
 */
open module build.jenesis.repository.contract.testkit.test {
