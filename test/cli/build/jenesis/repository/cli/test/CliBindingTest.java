...
public class CliBindingTest {
    ...
    private static final Map<String, Binding> BOUND = Map.ofEntries(
            ...
            Map.entry("staging", Binding.of("/api/staging", "staging", "releases")),
            Map.entry("retention", Binding.of("/admin/retention", "retention", "releases")),
            Map.entry("cleanup", Binding.of("/admin/cleanup", "cleanup", "releases")),
            Map.entry("pins", Binding.of("/admin/pins", "pins", "releases")),
            ...
            Map.entry("forget-ecosystem",
                    Binding.of("/admin/forget-ecosystem", "forget-ecosystem", "releases", "npm")),
            Map.entry("purge", Binding.of("/api/admin/orphans", "purge")),
            Map.entry("deploy", Binding.of("/releases/", "deploy", "releases", "/a/b.jar", "@FILE")),
            Map.entry("import", Binding.of("/admin/import", "import", "releases",
