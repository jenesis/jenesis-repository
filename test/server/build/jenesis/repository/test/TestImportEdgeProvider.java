 ...
 * yield. A downstream provider would instead need no config and claim the edge on presence alone; the required-config
...
public class TestImportEdgeProvider implements ImportEdgeProvider {
     ...
     *  {@code Features} API takes: the deployment key is {@code jenreg.<this>}, and {@code Features.key}
